  ...
  <div class="container">
    <div class="house-news-container">
        ...
        >
          ...
          <div class="house-content">
            ...
            <div class="meta">
              <div class="stats">
                <span
                  ><i class="el-icon-star-on"></i> {{ item.viewNumber }}</span
                >
      ...
      <div class="right">
        ...
        <div
          @click="houseNewsClick(news)"
          class="item-news"
          v-for="(news, index) in houseRecommedNewsList"
          :key="index"
        >
