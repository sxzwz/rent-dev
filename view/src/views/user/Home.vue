<template>
  <div class="container-home">
    ...
    <div class="reply" v-if="landlord === null">
      ...
      <div class="content">
        告别传统贴条招租，平台千万级流量曝光，精准匹配优质租客，让空房快速 “活”
        起来，租金收益不空置。
    ...
    <div class="content">
      ...
      <div class="house-container">
        ...
        <div>
          ...
          >
            ...
            <div class="area">
              ...
              <div>
                <span @click="changeAreaOperation" class="change-area"
                  >切换地区</span
                >
              </div>
            </div>
          ...
          >
            共为你查询到
            <span style="font-size: 20px;font-weight: 600;padding: 6px;">{{
              total
            }}</span>
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.sizeNumber === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.sizeNumber === item.label ? '600' : ''
                  }"
                  @click="houseSizeNumberClick(item)"
                  v-for="(item, index) in houseSizeNumberList"
                  :key="item.value"
                >
                  {{ item.label }}
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.rent === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight: conditionFilter.rent === item.label ? '600' : ''
                  }"
                  @click="houseRentClick(item)"
                  v-for="(item, index) in houseRentRangeList"
                  :key="item.value"
                >
                  {{ item.label }}
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.typeId === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.typeId === item.label ? '600' : ''
                  }"
                  @click="houseTypeClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.directionId === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.directionId === item.label ? '600' : ''
                  }"
                  @click="houseDirectionClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.sizedId === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.sizedId === item.label ? '600' : ''
                  }"
                  @click="houseSizedClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.depositMethodId === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.depositMethodId === item.label
                  ...
                  @click="houseDepositMethodClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.isSubway === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.isSubway === item.label ? '600' : ''
                  }"
                  @click="houseSubwayClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.fitmentStatusId === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.fitmentStatusId === item.label
                  ...
                  @click="houseFitmentStatusClick(item)"
            ...
            <div class="condition">
              ...
              <div class="item-condition">
                <div
                  :style="{
                    color:
                      conditionFilter.rentalType === item.label
                        ? 'rgb(31, 176, 129)'
                        : '',
                    fontWeight:
                      conditionFilter.rentalType === item.label ? '600' : ''
                  }"
                  @click="houseRentalTypeClick(item)"
        ...
        <div style="display: flex;justify-content: right;">
          <el-pagination
            ...
            :current-page="houseQueryDto.current"
            :page-sizes="[10, 20]"
            :page-size="houseQueryDto.size"
      ...
      <div class="right">
        ...
        <div
          @click="houseItemClick(house.id)"
          class="item-house"
          v-for="(house, index) in houseRecommedList"
          :key="index"
        >
...
export default {
  ...
  methods: {
    ...
    confirmFetchArea() {
      // 选中的省份
      const topAreaList = this.topArea.filter(
        area => area.id === this.topAreaId
      );
      // 选中的市区
      const cityAreaList = this.cityArea.filter(
        area => area.id === this.cityAreaId
      );
    ...
    houseSubwayClick(item) {
      ...
      this.houseQueryDto.isSubway =
        item.value === null ? null : item.value === 1;
      this.fetchHouseData();
    },
