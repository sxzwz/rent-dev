  ...
  <div class="visitor-home">
    ...
    <section class="featured-section">
      <div class="section-header">
        ...
        <a class="view-all" @click="goExplore"
      ...
      <div class="house-grid">
        <div
          class="house-card"
          @click="houseView(house)"
          v-for="(house, i) in featuredHouses"
          :key="i"
        >
...
export default {
  ...
  methods: {
    ...
    async fetchHousesNews() {
      try {
        const { data } = await this.$axios.post("/viewer/listHouseNews", {
          current: 1,
          size: 4
        });
    ...
    async fetchHouses() {
      try {
        const { data } = await this.$axios.post("/viewer/listHouse", {
          current: 1,
          size: 3
        });
