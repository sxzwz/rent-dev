<template>
  <div class="container">
      ...
      <div class="house-item" v-for="item in apiResult.data" :key="item.id">
        ...
        <div class="house-content">
          ...
          <div class="meta">
            ...
            <div class="actions">
              <div @click="houseNewsUpdate(item)">
    ...
    <el-drawer
      size="50%"
      :title="controlTextOperation ? '房屋资讯修改' : '房屋资讯新增'"
      :visible.sync="houseNewsDrawer"
      :direction="direction"
    >
      <div class="drawer-content">
        <el-form label-width="80px">
          <el-form-item label="*标题">
            <el-input
              placeholder="标题(30个字以内)"
              v-model="houseNews.title"
              clearable
            />
          </el-form-item>
          ...
          <el-form-item label="*摘要">
            <el-input
              type="textarea"
              :rows="4"
              placeholder="摘要(200字以内)"
              v-model="houseNews.summary"
            />
          </el-form-item>
