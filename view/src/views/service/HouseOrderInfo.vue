  ...
  <div class="container">
      ...
      <div>
        <el-table :data="apiResult.data">
          ...
          <el-table-column prop="orderStatus" width="168" label="状态">
            <template #default="scope">
              <el-tag size="mini" v-if="scope.row.orderStatus === 1"
                >预约中</el-tag
              >
              ...
              <div class="operate-buttons">
                <el-dropdown trigger="click" placement="bottom-end">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item
                      @click.native="deletedhouseOrderInfo(scope.row)"
                      icon="el-icon-delete"
                      >删除</el-dropdown-item
                    >
                  </el-dropdown-menu>
        ...
        <div class="pager">
          <el-pagination
            ...
            :current-page="houseOrderInfoQueryDto.current"
            :page-sizes="[10, 20]"
            :page-size="houseOrderInfoQueryDto.size"
    ...
    >
      <div style="display: flex;gap: 10px;">
        <div>
          <img
            style="border-radius: 5px;width: 100px;height: 70px;"
            :src="houseOrderInfo.cover"
            alt=""
            srcset=""
          />
        </div>
        ...
        <div>
          ...
          <div style="margin-top: 8px; color: #606266; font-size: 14px;">
            预约人：{{ houseOrderInfo.username || "-" }} &nbsp; 手机号：{{
              houseOrderInfo.phone || "-"
            }}
          </div>

          <div style="margin-top: 20px;display: flex;gap: 10px;">
            <div>
              <el-tag size="mini" v-if="houseOrderInfo.orderStatus === 1"
                >状态:预约中</el-tag
              >

              <el-tag
                size="mini"
                v-else-if="houseOrderInfo.orderStatus === 2"
                type="success"
                >状态:已预约</el-tag
              >
              ...
              <el-tag
                size="mini"
                v-else-if="houseOrderInfo.orderStatus === 3"
                type="danger"
                >状态:预约失败</el-tag
              >
              ...
              <el-tag
                size="mini"
                v-else-if="houseOrderInfo.orderStatus === 4"
                type="info"
                >状态:已取消</el-tag
              >
              ...
              <el-tag
                size="mini"
                v-else-if="houseOrderInfo.orderStatus === 5"
                type="success"
                >状态:已完成</el-tag
              >
            </div>
            ...
            <div>
              <el-tag size="mini" type="info"
                >预约日期:{{ houseOrderInfo.orderDate }}</el-tag
              >
            </div>

            <div>
              <el-tag size="mini" type="info">{{
                houseOrderInfo.orderTimeSplit
              }}</el-tag>
            </div>
          </div>
        </div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <span
          v-if="houseOrderInfo.orderStatus === 2"
          class="info-bt"
