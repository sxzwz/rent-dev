<template>
  <div class="container">
        ...
        <el-table-column prop="username" label="基本信息">
          <template #default="scope">
            <div style="display: flex;justify-content: left;gap: 10px;">
              <img
                style="border-radius: 5px;width: 70px;height: 50px;"
                :src="scope.row.houseCover"
                alt=""
                srcset=""
              />
              <div>
        ...
        <el-table-column label="操作" width="108" align="center">
          <template #default="scope">
            <div
              ...
              style="color: rgb(17, 139, 221);cursor: pointer;"
            >
              查看详情
            </div>
          </template>
    ...
    <!-- 房源流量申请信息抽屉 -->
    <el-drawer
      :title="houseFlowIndex.houseName"
      :modal="false"
    ...
    >
      <div>
        <div
          style="background-color: rgb(248,248,248);padding: 10px;margin-inline: 20px;"
        >
          <el-row :gutter="20">
            <el-col :span="6">
              <div>
                <el-statistic
                  group-separator=","
                  :precision="0"
                  :value="houseFlowIndex.showNumber"
                  :title="title"
                ></el-statistic>
              </div>
            </el-col>
        ...
        <div style="padding: 20px;">
          ...
          <Tab
            ...
            :initialActive="houseFlowIndexQueryDto.type"
            @change="handleChange"
          />
          <div>
